...
def getDatasets():
    ...
    rct_train = requests.get(DATASETS['rct']['data_dir_train'])
    rct_test = requests.get(DATASETS['rct']['data_dir_test'])
    ...
    saveDatasets(rct_train, "../data/rct_train.jsonl")
    saveDatasets(rct_test, "../data/rct_test.jsonl")
